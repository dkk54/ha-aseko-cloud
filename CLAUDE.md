...
- Brand assets (Aseko logo) are **not** yet submitted — needs a PR to
  `home-assistant/brands` adding `custom_integrations/aseko_cloud/icon.png`
  (256×256) and `logo.png` (landscape, ≤512 wide)
